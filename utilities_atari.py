...
ATARI_GAMES = collections.OrderedDict([
  ...
  ('ChopperNoFrameskip-v4','ChopperNoFrameskip-v4'),
  ...
  ('PrivateEyeFrameskip-v4','PrivateEyeFrameskip-v4'),
  ...
  ('TimePlotNoFrameskip-v4','TimePlotNoFrameskip-v4'),
...
HUMAN_SCORES_ATARI = {
  ...
  'PrivateEyeFrameskip-v4': 69571.3,
